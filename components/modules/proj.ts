...
// draw a Cairo ImageSurface (PNG) through the plane, centred at (u,v) with the given
// target width in UV space. height is auto-scaled to preserve aspect ratio.
export const tiltImage = (
    ...
    // wash the icon in a colour, masked by its own alpha so it doesn't bleed onto the tile
